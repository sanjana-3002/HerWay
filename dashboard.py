...
<body>
    <h1>🛡️ HerSafe Chicago</h1>
    <p class="subtitle">Community Safety Signals from Reddit · {len(df)} neighborhoods analyzed · {df['total_posts'].sum()} posts</p>
    ...
    <div class="section">
        ...
        <table>
            <tr><th>Neighborhood</th><th>Total Posts</th><th>😨 Fearful</th><th>⚠️ Concerned</th><th>✅ Reassuring</th><th>Fear %</th></tr>
            {make_rows(high)}
        </table>
    </div>
    ...
    <div class="footer">
        HerSafe · Data sourced from Reddit community posts · For research purposes only
    </div>
</body>
</html>"""

with open("hersafe_dashboard.html", "w") as f:
    f.write(html)
